...
% make sure to first activate python with something like source. 
% also, add to path Spike_Alignment folder and fieldtrip
% ~/venvs/my_virtual_python_env/bin/activate
% pybin = '/home/poggigp/venvs/spike_align_py312/bin/python';
% 
% cmd = sprintf([ ...
%     'bash -c ''unset LD_LIBRARY_PATH; ' ...
%     '"%s" -u "%s" --cfg_json "%s" --out_subdir SpikeAligned ' ...
%     '--Fs 30000 --bin_ms 1 --win_before 2.0 --win_after 1.5 ' ...
%     '--win_before_base 0 --win_after_base 1 --qualities 4,5''' ], ...
