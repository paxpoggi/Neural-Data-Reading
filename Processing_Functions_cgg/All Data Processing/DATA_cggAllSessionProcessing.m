...
cgg_procFullTrialPreparation_v3(...
    'inputfolder',cfg(sidx).inputfolder,'outdatadir',cfg(sidx).outdatadir,'Epoch',Epoch, 'ExperimentName', ExperimentName, 'monkey_name', monkey_name, 'detrend_flatten_only', false, 'do_zscore', false);
